      ...
      {stats.map((stat, index) => {
        ...
        return (
          <motion.div
            ...
            className="h-full"
          >
            <div className="group relative h-full flex flex-col rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all hover:bg-white/10 hover:shadow-xl hover:shadow-white/5">
              ...
              <div className="mb-4 flex items-center justify-between flex-shrink-0">
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 ring-1 ring-white/10 transition-colors group-hover:bg-white/10 group-hover:ring-white/20 flex-shrink-0">
                  <Icon className="h-5 w-5 text-white/80 group-hover:text-white" />
                </div>
              </div>
              
              <div className="flex-1 flex flex-col justify-end space-y-1">
                <div className="text-3xl font-bold text-white tracking-tight leading-none">{stat.value}</div>
                <p className="text-sm text-white/40 line-clamp-2">{stat.description}</p>
              </div>
            </div>
          </motion.div>
        )
